      ...
      <div className='p-6 bg-white rounded-md shadow-md'>
        ...
        <form className='mt-6' onSubmit={handleSubmit(onSubmit)}>
          <div className='mb-2'>
            ...
            <input type='email' id='email' {...register('email', userEmail)} className='w-full px-4 py-2 mt-2 bg-white border rounded-md'/>
            {errors?.email &&
              <div>
          ...
          <div className='mb-2'>
            ...
            <input type='text' id='name' {...register('name', userName)} className='w-full px-4 py-2 mt-2 bg-white border rounded-md'/>
            {errors?.name &&
              <div>
          ...
          <div className='mb-2'>
            ...
            <input type='password' id='password' {...register('password', userPassword)} className='w-full px-4 py-2 mt-2 bg-white border rounded-md'/>
            {errors?.password &&
              <div>
          ...
          <p className='mt-8 text-xs font-light text-center text-gray-700'>
            아이디가 있다면{" "}
            <a href='/login' className='font-mediun hover:underline'>로그인</a>
          </p>
        </form>
      </div>
    </section>
